...
// 이러면 리소스를 효율적으로 쓸 수 있다.
console.log(yuJin3.sayHello === wonYoung3.sayHello);

console.log(yuJin3.hasOwnProperty('sayHello')); // 고유 프로퍼티가 아니다. 상속 프로퍼티다.
 ...
 * 
 * 인스턴스의 _proto__ 변경 vs 함수의 prototype 변경
 */
function IdolModel(name, year){
  this.name = name;
  this.year = year;
...
// 인스턴스와 원래 프로토타입과의 연결이 아예 끊기게 됨

console.log(FemaleIdolModel.prototype === IdolModel.prototype);


// 아래와 같은 경우는 생성자 함수와 기존의 프로토타입만 연결이 끊어짐
